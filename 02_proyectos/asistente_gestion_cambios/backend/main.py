...
POC: solo Módulos 1 (Solicitud) y 2 (Aprobación). Implementación,
Verificación y Trazabilidad quedan para después de validar este patrón
...
from .routers import aprobaciones, solicitudes
